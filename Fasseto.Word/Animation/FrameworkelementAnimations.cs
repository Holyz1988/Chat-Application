...
{
    /// <summary>
    /// Helpers to animate Framework element in specific ways
    /// </summary>
    public static class FrameworkelementAnimations
    {
        ...
        /// <param name="keepMargin">Whether to keep the lement at the same width during animation</param>
        /// <returns></returns>
        ...
        public static async Task SlideAndFadeOutToLeftAsync(this FrameworkElement element, float seconds = 0.3f, bool keepMargin = true)
        {
            ...
            // Make framework element visible
            element.Visibility = Visibility.Visible;
